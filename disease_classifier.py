...
diseases_model = [Apple_model,Badam_model,Blueberry_model,Cherry_model,Corn_model,Grape_model,Orange_model,Paddy_model,Peach_model,Pepper_model,Potato_model,Raspberry_model,Rose_model,Soyabean_model,Squash_model,Strawberry_model,Sunflower_model,Tomato_model]

if no species
first find species
then x = species[predict]]
diseases[x][diseases_model[x].predict()]